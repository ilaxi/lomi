...
ALLOWED_HOSTS = [".replit.dev", ".replit.app", "127.0.0.1", "localhost", ".ngrok-free.app", "pythonanywhere.com"]
CSRF_TRUSTED_ORIGINS = ["https://*.replit.dev", "https://*.replit.app","https://*.ngrok-free.app", "https://*.pythonanywhere.com"]
