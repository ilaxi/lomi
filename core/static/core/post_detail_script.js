...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const commentRemoveImageButton = document.getElementById('comment-removeImageButton');
    if (commentRemoveImageButton) {
        commentRemoveImageButton.addEventListener('click', function() {
    ...
    if (commentTextarea && commentBoldButton && commentH4Button) {
        // Track button states
